    ...
    Burgers: [
      {
        ...
        category: "Burgers",
        description:
          "A quarter-pound* of flame-grilled beef with melted American cheese",
      },
      {
        id: "kfc-burger-2",
        ...
        category: "Burgers",
        description: "Our signature Big Mac with extra toppings",
      },
      {
        id: "kfc-burger-3",
        ...
        category: "Burgers",
        description: "Two quarter-pound beef patties",
      },
      {
        id: "kfc-burger-4",
        ...
        category: "Burgers",
        description: "Premium chicken fillet with fresh lettuce",
      },
      {
        id: "kfc-burger-5",
        ...
        category: "Burgers",
        description: "Combo meal for three",
      },
      {
        id: "kfc-burger-6",
        ...
        category: "Burgers",
        description: "Crispy, fiery chicken fillet",
      },
    ],
    Sandwiches: [
      {
        ...
        category: "Sandwiches",
        description: "Plant-powered sandwich with fresh veggies",
      },
      {
        id: "kfc-sandwich-2",
        ...
        category: "Sandwiches",
        description: "Grilled panini with sun-dried tomatoes",
      },
      {
        id: "kfc-sandwich-3",
        ...
        category: "Sandwiches",
        description: "Panini with peanut butter and bananas",
      },
      {
        id: "kfc-sandwich-4",
      ...
      },
      {
        ...
        category: "Sandwiches",
        description: "Grilled sandwich with gooey melted cheese",
      },
      {
        id: "kfc-sandwich-6",
        name: "Deli Stack Sub",
        ...
        category: "Sandwiches",
        description: "Classic sub loaded with ham and salami",
      },
    ],
    Buckets: [
      {
        ...
        category: "Buckets",
        description: "Signature fried chicken bucket",
      },
      {
        id: "kfc-bucket-2",
        ...
        category: "Buckets",
        description: "Bucket of golden drumsticks",
      },
      {
        id: "kfc-bucket-3",
        ...
        category: "Buckets",
        description: "Overflowing bucket of crispy chicken",
      },
      {
        id: "kfc-bucket-4",
        name: "Ultimate Savings Bucket",
        price: 7.49,
        image: "/Images/bucket4.jpg",
        category: "Buckets",
        description: "Value-packed bucket",
      },
      {
        id: "kfc-bucket-5",
        ...
        category: "Buckets",
        description: "Fiery bucket with bold seasoning",
      },
      {
        id: "kfc-bucket-6",
        ...
        category: "Buckets",
        description: "Crispy chicken paired with Pepsi",
      },
    ],
    "Rice Bowls": [
      {
        ...
        category: "Rice Bowls",
        description: "Rice bowl topped with golden fried chicken",
      },
      {
        id: "kfc-ricebowl-2",
        ...
        category: "Rice Bowls",
        description: "Seasoned rice with crispy drumstick",
      },
      {
        id: "kfc-ricebowl-3",
        ...
        category: "Rice Bowls",
        description: "Rice bowl with crispy chicken and fresh veggies",
      },
      {
        id: "kfc-ricebowl-4",
        ...
        category: "Rice Bowls",
        description: "Seasoned rice with crispy chicken fingers",
      },
      {
        id: "kfc-ricebowl-5",
        ...
        category: "Rice Bowls",
        description: "Crispy edible bowl filled with seasoned rice",
      },
      {
        id: "kfc-ricebowl-6",
        ...
        category: "Rice Bowls",
        description: "Colorful rice bowl topped with juicy chicken",
      },
    ],
    Desserts: [
      {
        ...
        category: "Desserts",
        description: "Vanilla soft serve blended with cookies or candies",
      },
      {
        id: "kfc-dessert-2",
      ...
      },
      {
        ...
        category: "Desserts",
        description: "Rich fudgy brownie with three types of chocolate",
      },
      {
        id: "kfc-dessert-5",
        ...
        category: "Desserts",
        description: "Shake made with real bananas",
      },
      {
        id: "kfc-dessert-6",
        ...
        category: "Desserts",
        description: "Vanilla soft serve with warm caramel",
      },
    ],
    "Hot drinks": [
      {
        ...
        category: "Hot drinks",
        description: "Rich freshly brewed coffee",
      },
      {
        id: "kfc-hotdrink-2",
      ...
      },
      {
        ...
        category: "Hot drinks",
        description: "Caffeine-free herbal teas",
      },
    ],
  };
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-white rounded-lg p-4 flex space-x-4 relative">
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-600 mb-3">
                    Creamymade with real bananas and topped with whipped cream
                    and a cherry.
                  </p>
                  <span className="text-xl font-bold text-gray-900">
                    GBP 3.99
