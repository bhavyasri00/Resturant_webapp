    ...
    "Chicken Meals": [
      {
        ...
        price: 12.99,
        description:
          "Our signature spicy fried chicken with Texas-style seasoning, perfectly crispy and full of flavor.",
      ...
      },
      {
        ...
        price: 13.99,
        description:
          "Tender chicken glazed with our signature honey BBQ sauce, grilled to perfection.",
      ...
      },
      {
        ...
        price: 11.49,
        description:
          "Classic buffalo wings with tangy sauce, served with celery sticks and blue cheese dip.",
      ...
      },
      {
        ...
        price: 10.99,
        description:
          "Hand-breaded chicken tenders, golden and crispy, served with your choice of dipping sauce.",
      ...
      },
      {
        ...
        price: 14.99,
        description:
          "Juicy grilled chicken breast seasoned with herbs and spices, served with mashed potatoes.",
      ...
      },
      {
        ...
        price: 9.99,
        description:
          "Succulent chicken drumsticks marinated in our secret blend of spices and grilled to perfection.",
    ...
    "Burgers & Wraps": [
      {
        ...
        price: 8.99,
        description:
          "Crispy fried chicken breast with lettuce, tomato, and our signature Texas sauce on a brioche bun.",
      ...
      },
      {
        ...
        price: 10.49,
        description:
          "Beef patty with crispy bacon, BBQ sauce, cheese, and onion rings on a toasted sesame bun.",
      ...
      },
      {
        ...
        price: 7.99,
        description:
          "Grilled chicken strips with lettuce, tomatoes, cheese, and spicy mayo wrapped in a soft tortilla.",
    ...
    Desserts: [
      {
        ...
        price: 5.99,
        description:
          "Traditional Texas pecan pie with a flaky crust and rich filling.",
      ...
      },
      {
        ...
        price: 4.99,
        description:
          "Dense chocolate brownie with chocolate chips, served warm with chocolate sauce.",
      ...
      },
      {
        ...
        price: 5.49,
        description:
          "Classic apple cobbler with cinnamon and a golden crispy topping.",
